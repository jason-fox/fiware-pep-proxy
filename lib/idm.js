...
const IDM = (function () {
  ...
  const checkToken = function (
    ...
    options.headers['X-Auth-Id-List'] = req.locals.ids ? req.locals.ids.join(',') : '';
    options.headers['X-Auth-Attributes-List'] = req.locals.attrs ? req.locals.attrs.join(',') : '';
    options.headers['X-Auth-Types-List'] = req.locals.types ? req.locals.types.join(',') : '';
